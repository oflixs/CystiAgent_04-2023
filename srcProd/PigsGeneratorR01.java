...
rows:             
            ...
            { 
                ...
                if(line.get(11).equals("."))continue;
        ...
        System.out.println (pigsPerHouseDist);
    ...
    public void createSinthPopNumberAndHouses()
    {
        ...
        for(int i = 0; i < sim.householdsBag.size(); i++)
        {
            ...
            double rand = state.random.nextDouble();
            if(rand > sim.householdsGen.popFractHousesOwningPigs)continue;
        ...
        System.out.println ("Fract houses owning pigs from survey: " + sim.householdsGen.popFractHousesOwningPigs);
