...
public class CensedPig 
{
    ...
    public List<Integer> roundsAgesInMonths = new ArrayList<Integer>(); 
    public List<Integer> roundsAgesCorrected = new ArrayList<Integer>(); 
    public List<Integer> roundsAgesCorrectedInMonths = new ArrayList<Integer>(); 
    ...
    public List<String> roundsHousehold = new ArrayList<String>(); 

    public List<String> tongueInspection = new ArrayList<String>(); 

    public List<Integer> roundsHouseholdsSeroIds = new ArrayList<Integer>(); 
    ...
    public CensedPig(SimState pstate, int pid)
    {
        ...
        for(int i = 0; i < 9; i++)
        {
            ...
            roundsBands.add(-100);
            roundsAges.add(-100);
            roundsAgesInMonths.add(-100);
            roundsAgesCorrected.add(-100);
            roundsAgesCorrectedInMonths.add(-100);
            wbValue.add("-100");

            roundsHouseholdsSeroIds.add(-100);
    ...
    public void printResume()
    {
        ...
        System.out.println("Id stString: " + IDString);
        ...
        for(int i = 1; i < 8; i++)
        {
            tmpS.add(roundsVillages.get(i));
        }
        System.out.println("Round villages: " + tmpS);

        tmp = new ArrayList<Integer>(); 
        for(int i = 1; i < 8; i++)
        {
            tmp.add(roundsHouseholdsSeroIds.get(i));
        }
        System.out.println("Round households: " + tmp);
        ...
        for(int i = 1; i < 8; i++)
        {
            tmp.add(roundsNotMissing.get(i));
        }
        System.out.println("Round with serological data" + tmp);
