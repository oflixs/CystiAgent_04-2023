...
public class DemoModule implements Steppable
{
    ...
    public void step(SimState state)
    {
        ...
        Bag tmpBag = new Bag(sim.humansBag);
        ...
        tmpBag = new Bag(sim.emigrantsBag);
        for(int i = 0; i < tmpBag.size(); i++)
        {
            Human h = (Human)tmpBag.get(i);
    ...
    public Human extractHumanFromVillagePicture(int refAge, Human human)
    {
        ...
        human.sewerUser = hImmigrant.sewerUser;
    ...
    public void resetHuman(Human human)
    {
        ...
        if(sim.cystiHumans)
        {
            ...
            int size = Integer.valueOf(human.cysts.size());
            ...
            //System.out.println(size + "  " + human.cysts.size());
            human.cysts = new Bag();
        }
    }
