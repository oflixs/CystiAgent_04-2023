...
public class ABCCalibrationControl implements Serializable
{
    ...
    public void run()
    {
        ...
        for(int s = 0; s < ext.numStagesABC; s++)
        {
            ...
            abcSingle.doAnalysis.analysisIndip("master", "printRuns", abcSingle.numRunsToBeAccepted);
            //System.exit(0);
    ...
    public void readStageDone(int stage)
    {
        ...
        try
        {
            ...
            strLine = br.readLine();//this reads the line global parameters -------
    ...
    public Double getRunDist(Long j)
    {
        ...
        for(int i = 0; i < res.size(); i++)
        {
            ...
            if(printOut)System.out.println ("Weight: " + abcSingle.stageTargetsWeights.get(i));
            ...
            tmp = abcSingle.stageTargetsWeights.get(i) * tmp;
