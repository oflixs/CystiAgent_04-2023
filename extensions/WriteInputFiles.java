...
public class WriteInputFiles implements Serializable
{
    ...
    public void writeSimParametersInputOutcome(String villageName, OutcomesPool outPool)
    {
        ...
        System.out.println("Village params file: " + inputFile);
        //System.exit(0);
        ...
        try{
            ...
            while ((strLine = br.readLine()) != null)   {
                ...
                if(words[0].equals("readPopFromSurveyCensusFile"))
                {
                    String tmp = "readPopFromSurveyCensusFile " + ext.readPopFromSurveyCensusFile;
                    strLine = tmp;
            ...
            if(!writeReadPopFromFile)
            {
                ...
                tmp = "readPopFromSurveyCensusFile " + ext.readPopFromSurveyCensusFile;
                strLine = tmp;
                textFile.add(strLine);
            }
        ...
        try {
            //gt.newInputFileName = "NewTest.params";
            //System.err.println("Writing to: " + inputFile);
    ...
    public void writeCompileAndRun(OutcomesPool outPool)
    {
        ...
        try {
            ...
            fop.close();
            System.out.println("New batch File: " + outPool.runFile + " created.");
    ...
    public void writeCoreInput()
    {
        ...
        try{
            ...
            while ((strLine = br.readLine()) != null)   {
                ...
                if(strLine.startsWith("allVillagesInOneSim") )
                {
                    String tmp = "";
                    //System.out.println (strLine);
                    tmp = "allVillagesInOneSim ";
                    if(ext.allVillagesInOneSim)tmp = tmp  + " true";
                    else tmp = tmp  + " false";
        ...
        try {
            ...
            while(!file.canRead() || !file.canWrite())
            {
                ...
                System.out.println (coreInputFile);
                try {         
                    Thread.sleep(500);
