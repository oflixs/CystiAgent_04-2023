...
~/jdk-16.0.2/bin/java -Xmx16384m -cp "./:../allJar/*" extensions.Extensions extensionsABC_R01_adherence_propDef_xxx.params
...
#~/jdk-16.0.2/bin/java -Xmx16384m -cp "./:../allJar/*" extensions.Extensions extensionsABC_TTEMP_seroconversion.params
