    ...
    public void rmOldFiles(String prefix, int nMins, String type)
    {
        ...
        try{
            ...
            if(osName.equals("Windows 10"))
            {
                ...
                com = "bash -c \"/cygdrive/c/cygwin/bin/find.exe " + prefix  + "* -type " + type  +  " -mmin +" +nMins + " -exec rm -f {} \\;\"";
                if(type.equals("d"))
            ...
            {
               //delete the file whose name starts with the prefix that are older thant the last nMis minutes
                com = "bash -c \"find " + prefix  + "* -type " + type  +  " -mmin +" +nMins + " -exec rm -f {} \\;\"";
                if(type.equals("d"))
                    com = "bash -c \"find " + prefix  + "* -type " + type  +  " -mmin +" +nMins + " -exec rm -rf {} \\;\"";
                //String com = "find ../time_* -type f -mtime +1 -exec rm -f {} \\";
            }
