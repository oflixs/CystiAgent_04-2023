...
public class WriteShp implements Steppable
{
    ...
    public GeomVectorField housesWrite = new GeomVectorField();
    ...
    public void writeHouseholds()
    {
        ...
        addAttributesToHouseholds2();

        //ShapeFileExporter.write(fileNameHouseholds, sim.homes);
        ShapeFileExporter.write(fileNameHouseholds, housesWrite);
    }

    //====================================================
    public void addAttributesToHouseholds2()
    {
        ...
        for(int i = 0; i < sim.householdsBag.size(); i++)
        {
            ...
            MasonGeometry mgHome = new MasonGeometry(hh.geoPoint);
            ...
            mgHome.addIntegerAttribute("nTapeworms", hh.nTapeworms);
            mgHome.addIntegerAttribute("nInfPigs", hh.nInfPigs);
            mgHome.addIntegerAttribute("nPosPigs", hh.nPosPigs);

            housesWrite.addGeometry(mgHome);
        }
