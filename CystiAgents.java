...
public /*strictfp*/ class CystiAgents extends SimState  
{
    ...
    public boolean readPopFromSurveyCensusFile = false;
    ...
    public boolean sinthHumanPop = false;
    public boolean sinthPigNumberPop = false;
    public boolean sinthPigNumberAndHousesPop = false;
    public boolean sinthLatrineDistribution = false;
    public boolean sinthCorralDistribution = false;
    public boolean sinthHouseholdsSameLoc = false;
    ...
    public double seroConvertPtoEFact = 0.0;//tuning paramenter 
    public double seroConvert = 0.0;//tuning paramenter 
    public List<Integer> cohortSeroIncAges = new ArrayList<Integer>();
    public List<Integer> cohortSeroIncAgesInMonths = new ArrayList<Integer>();
    public int seroincidenceCohortsPer = 0;
    public int seroincidenceCohortsNumRounds = 0;
    public int seroincidenceCohortsPerWrite = 0;
    ...
    public Boolean useLandCover = false;
    public Boolean landCoverIrrigationChannels = false;
    public Boolean landCoverAgriculturalLand = false;
    public GeomVectorField irrigationChannels = new GeomVectorField();
    public GeomVectorField irrigationChannelsPolygon = new GeomVectorField();
    public GeomVectorField agriculturalLand = new GeomVectorField();
    ...
    public PigsGeneratorGATES1 pigsGenGATES1;
    public PigsGeneratorGATES2 pigsGenGATES2;
    ...
    public InterventionsTTEMP interventionsTTEMP = null;
    public InterventionsTest interventionsTest = null;
    public InterventionsAfricanSwineFever interventionsAfricanSwineFever = null;
    ...
    public double propDefInsideRadius = 0.0;
    public double adherenceToLatrineBorderEffect = 0.0;
    public double fractHousesBorder = 0.0;

    public double seroPrevHousesInTheBorder = 0.0;
    public double seroPrevHousesNotInTheBorder = 0.0;
    public double seroPrevHousesInTheBorderNorm = 0.0;
    public double seroPrevHousesNotInTheBorderNorm = 0.0;
    ...
    public double strangerTravelersProp = 0.0;
    ...
    public int minAgeToEatPork = 2;//minimum age to eat pork in years
    ...
    public Bag censedPigsBagTTEMPBC = new Bag();
    ...
    public int numPigletsPerFarrow = 0;
    ...
    public String  interventionsType = "";
    public boolean doInterventionsTest = false;
    public int  interventionRepetitions = 0;
    public int  interventionStep = 0;
    public int  roundSero = 0;
    public int  serosampleDone = 0;
    ...
    public double niclosamideTreatEff = 0.0;
    ...
    public List<Double> obsSeroIncidencePigsRounds = new ArrayList<Double>();//calculated over the seroincidence cohort
    public List<Double> obsSeroPrevalencePigsRounds = new ArrayList<Double>();//calculated over the pigs 
    public List<Double> obsOverallSeroPrevalencePigsRounds = new ArrayList<Double>();//calculated over the pigs 
    //with ages > 4 months
    public List<Double> obsSeroPrevalencePigletsRounds = new ArrayList<Double>();//calculated over the pigs
    //woth ages > 1.5 months and < 4 months

    public List<Double> obsPrevTonguePositiveRounds = new ArrayList<Double>();//calculated over the pigs

    public double avgSimPrevHTFinal = 0.0;
    public double avgSimPrevPCFinal = 0.0;

    public int intRounds = 0;//intervention number of rounds
    ...
    public double pigAgeEligibleForTreatment = 0.0;
    public double treatPartP = 0.0;
    public double treatPart = 0.0;
    public double oxfProtection = 0.0;
    public double oxfTreatEff = 0.0;
    public double slaughterStopTimeAfterTreatment = 0.0;
    ...
    public double seroIncidencePigs = 0.0;
    public double seroIncidencePigsNorm = 0.0;
    public double seroPrevalencePigsNorm = 0.0;
    public double seroPrevalencePigletsNorm = 0.0;

    public double perseroPrevalencePiglets = 0.0;
    public double perseroPrevalencePigletsNorm = 0.0;
    public double perseroPrevalenceAgeTransition = 0.0;
    public double perseroPrevalenceAgeTransitionNorm = 0.0;
    public double perseroPrevalencePigsAdult = 0.0;
    public double perseroPrevalencePigsAdultNorm = 0.0;
    public double perseroPrevalencePigsYoung = 0.0;
    public double perseroPrevalencePigsYoungNorm = 0.0;

    public List<Double> interSeroIncidencePigsRounds = new ArrayList<Double>();//calculated over the seroincidence cohort
    public List<Double> interSeroPrevalencePigsRounds = new ArrayList<Double>();//calculated over the pigs 
    public List<Double> interSeroPrevalencePigsCohortsRounds = new ArrayList<Double>();//calculated over the pigs 
    public List<Double> interOverallSeroPrevalencePigsRounds = new ArrayList<Double>();//calculated over the pigs 
    //with ages > 4 months
    public List<Double> interSeroPrevalencePigletsRounds = new ArrayList<Double>();//calculated over the pigs
                                                                                   //
    public List<List<Double>> interSeroIncidencePigsRoundsValues = new ArrayList< List<Double>>();//calculated over the seroincidence cohort
                                                                                   //
    public List<Double> interHTRounds = new ArrayList<Double>();//calculated over the pigs
    public List<Double> interPCRounds = new ArrayList<Double>();//calculated over the pigs
 
    public List<Double> avgInterSeroIncidencePigsRounds = new ArrayList<Double>();//calculated over the seroincidence cohort
    public List<Double> avgInterSeroPrevalencePigsRounds = new ArrayList<Double>();//calculated over the pigs 
    public List<Double> avgInterSeroPrevalencePigsCohortsRounds = new ArrayList<Double>();//calculated over the pigs 
    public List<Double> avgInterOverallSeroPrevalencePigsRounds = new ArrayList<Double>();//calculated over the pigs 
    //with ages > 4 months
    public List<Double> avgInterSeroPrevalencePigletsRounds = new ArrayList<Double>();//calculated over the pigs
                                                                                      //
    public List<Double> avgHTRounds = new ArrayList<Double>();//calculated over the pigs
    public List<Double> avgPCRounds = new ArrayList<Double>();//calculated over the pigs
                                                                                      //
    public List<Double> avgInterNumPigsRounds = new ArrayList<Double>();//calculated over the pigs
    public List<Double> avgInterNumPigsInfectedRounds = new ArrayList<Double>();//calculated over the pigs

    public List<Double> avgInterPrevTonguePositiveRounds = new ArrayList<Double>();//calculated over the pigs

    public double pigletsnPrint = 0.0;
    public double pigsnPrint = 0.0;
    public double seroincnPrint = 0.0;
    public double seroincnPrintNorm = 0.0;
    ...
    public int nTotPigs=0;

    public int nPigsExposedIn = 0;
    public int nPigsExposedOut = 0;
...
//    public double averageShareEverTaenia60; // GB17mars
    ...
    public Boolean startAllDone = false;

    public double test = 0.0;
    public double testCount = 0.0;
